...
const create_company_dto_2 = require("./dto/create-company.dto");
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, roles_decorator_1.Roles)(user_entity_1.UserRole.SUPER_ADMIN, user_entity_1.UserRole.COMPANY_OWNER),
    __param(0, (0, common_1.Param)('id')),
